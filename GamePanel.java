...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g){ 
        if(running){
            //grid ( REMOVE/COMMENT OUT CODE BETWEEN ## ## IF YOU DON'T WANT THE GRID )
            // ##
            ...
            for(int i=0; i<bodyParts;i++){
                if(i==0){
                    ...
                    //Uncomment the line below for a multicolor snake
            ...
            FontMetrics metrics= getFontMetrics(g.getFont()); //lining up font in middle
    ...
    public void checkCollision(){
        //checks if head touches body part
        for(int i = bodyParts;i>0;i--){
            if((x[0]==x[i])&&(y[0]==y[i])){
                running=false;
            }
    ...
    public void gameOver(Graphics g){
        ...
        FontMetrics metrics1= getFontMetrics(g.getFont()); //lining up font in middle
